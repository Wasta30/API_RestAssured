...
public class SpartanGetRequest {
    ...
    String baseUrl = "http://18.234.107.50:8000";
...
//    And response body should include spartan result
    ...
    public void test1(){
        ...
        // i will save my response object in response
...
// printing response Content Type from response object
        ...
        // verfiy content type os application json
    ...
    public void test2(){
        ...
        //if u want to go to the background of use control + click
    ...
    public void test3(){
        ...
        // verify content length is 17, the header method return string thats why i put 17 in double quote
